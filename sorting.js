...
const reduceFunc = foodOrders.reduce(function (previousValue, currentValue) {
...
const weatherStates = weather
    .map(weatherState => weatherState['weather_state_name'])
    .filter((weatherState, index, weatherArr) => weatherArr.indexOf(weatherState) === index);
console.log(weatherStates);

//find the id of the object in weather that has a min_temp of 15.915

const idealTemp = [];
for (const element of weather) {
    if(element.min_temp === 15.915) {
        idealTemp.push(element.id);
    }
}
